                ...
                maxWidth > 600
                    ? Row(
                        ...
                        children: [
                          ...
                          DatePickWidget(
                            onDateSelected: _presentDatePicker,
                          ),
                          CancelButton(),
                    ...
                    : Row(
                        ...
                        children: [
                          ...
                          Text(_selectedDate == null
                              ? 'Selected Date'
                              : formatter
                                  .format(_selectedDate!)), //ternary operator
                          DatePickWidget(
                            onDateSelected: _presentDatePicker,
                          )
                        ],
...
class DatePickWidget extends StatelessWidget {
  const DatePickWidget({super.key, required this.onDateSelected});
...
class SaveButtonWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return ElevatedButton(onPressed: onPressed, child: Text('Save Expense'));
  }
}
